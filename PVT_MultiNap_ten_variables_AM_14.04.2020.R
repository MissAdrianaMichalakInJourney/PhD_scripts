...
setwd("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Data\\MultiNap\\") #set directory

getwd()

files <-dir(path = "C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Data\\MultiNap\\", recursive = TRUE,include.dirs = TRUE,pattern = "^APO(.*)csv$")
print (files)
...
for (k in 1:length(files))
{
  ...
  # The following PVT outcome metrics were assessed and included in our analyses: 
  ...
  RT1<- data.frame ('participant_ID'= form[k],'session_number'=form1[k],'protocol'="2", 'date' = my.data$SessionDate, 'time' = my.data$SessionTime,'median_RT'=median_RT,
                    'mean_RT'= mean_RT, 'fastest_10%_RT'= fastest_10_RT, 'slowest_10%_RT' = slowest_10_RT, 'reciprocal_10%_slowest_RT'=slowest_10_reciprocal_RT, 'response_speed' = reciprocal_RT,
  ...
  form = files
  pathOut= ("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Outcomes\\MultiNap\\ten_variables\\")
...
setwd("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Outcomes\\MultiNap\\ten_variables\\") #set directory
#select file names to be merged, i.e., outcomes of the for loop above
merge <- list.files (path="C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Outcomes\\MultiNap\\ten_variables\\", pattern = "APO")
print(merge)
...
write.csv (outcomes.all.ppt_PVT_MultiNap,"C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\PVT\\Outcomes\\PVT_RT_ten_variables_MultiNap_Final_AM_16.12.2020.csv",row.names=F)
