...
write.csv(combine_MN_SD,"C:\\Users\\adria\\Desktop\\PhD\\Rrr\\SHQ\\Outcomes\\SHQ_outcomes_wayfinding_normalized_AM_15.12.2020.csv",row.names=F) # it will generate the .csv with the outcomes of interest for each participants, we will merge them below
