...
# Supermarket task - FINAL - averages - suitable for analysis of the data collected AFTER the update in April 2019 - author: Adriana Michalak - 11.05.2020
...
write.csv (outcomes.all.ppt,"C:\\Users\\adria\\Desktop\\PhD\\Rrr\\Supermarket_AM\\Outcomes\\Supermarket_outcomes_averages_2_AM_11.05.2020.csv",row.names=F) # save the merged database under given directory and given name (last bit before .csv)
