...
mental_effort <- data.frame ('id'= data$ID,'age'= data$age,'sex'=data$Sex_M_1_F_2,'genotype'=data$Genotype_1_e4_positive_2_e4_negative,'session_number'=data$COGT_number,'protocol'=data$protocol_1_SD_2_MN, 
                             ...
                             'SHQ_Flare_hard_normalized'=data$normalized_SHQ_flare_hard, 'SHQ_Map_easy_normalzied'=data$normalized_SHQ_map_easy, 'SHQ_Map_hard_normalized'=
                               ...
                               data$Normalized_Episodic_Memory_Recall, 'overall_normalized'=data$normalized_whole_session, 'hours_of_sleep_baseline'= data$TST_Baseline_min)
...
lmer_PVT_mental_efforts <- lmer(PVT_mental_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                  protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_PVT_mental_effort <- lsmeans(lmer_PVT_mental_efforts , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_n_back_mental_effort <- lmer(n_back_mental_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                    protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_n_back_mental_effort <- lsmeans(lmer_n_back_mental_effort , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_SHQ_FLARE_EASY_meantal_effort <- lmer(SHQ_FLARE_EASY_meantal_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                             protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_SHQ_FLARE_EASY_meantal_effort <- lsmeans(lmer_SHQ_FLARE_EASY_meantal_effort , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_SHQ_FLARE_HARD_mental_effort <- lmer(SHQ_FLARE_HARD_mental_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                            protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_SHQ_FLARE_HARD_mental_effort <- lsmeans(lmer_SHQ_FLARE_HARD_mental_effort , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_SHQ_MAP_EASY_mental_effort <- lmer(SHQ_MAP_EASY_mental_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                          protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_HQ_MAP_EASY_mental_effort <- lsmeans(lmer_SHQ_MAP_EASY_mental_effort , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_SHQ_MAP_HARD_mental_effort <- lmer(SHQ_MAP_HARD_mental_effort ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                          protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_SHQ_MAP_HARD_mental_effort <- lsmeans(lmer_SHQ_MAP_HARD_mental_effort , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_Episodic_memory_ENCODING <- lmer(Episodic_memory_ENCODING ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                        protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_Episodic_memory_ENCODING <- lsmeans(lmer_Episodic_memory_ENCODING , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_Episodic_memory_RECALL <- lmer(Episodic_memory_RECALL ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                      protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_Episodic_memory_RECALL <- lsmeans(lmer_Episodic_memory_RECALL , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_How_cognitively_demanding_was_all_the_session <- lmer(How_cognitively_demanding_was_all_the_session ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                                             protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort, na.action = na.exclude)
...
lms_How_cognitively_demanding_was_all_the_session <- lsmeans(lmer_How_cognitively_demanding_was_all_the_session , ~ session_number*protocol*genotype) # plot main effect of: genotype, protocol
...
lmer_PVT_mental_efforts <- lmer(PVT_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                  protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

PVT_mental <- anova (lmer_PVT_mental_efforts )
write.csv(PVT_mental, 'C:\\Users\\adria\\Desktop\\PVT_mental.csv')

PVT_mental_eta <- eta_sq(lmer_PVT_mental_efforts )
write.csv(PVT_mental_eta, 'C:\\Users\\adria\\Desktop\\PVT_mental_eta.csv')
...
lmer_n_back_mental_effort <- lmer(n_back_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                    protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)
...
lmer_SHQ_FLARE_EASY_meantal_effort <- lmer(SHQ_Flare_Easy_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                             protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

SHQ_FLARE_easy <- anova (lmer_SHQ_FLARE_EASY_meantal_effort )

write.csv(SHQ_FLARE_easy, 'C:\\Users\\adria\\Desktop\\SHQ_FLARE_easy.csv')

SHQ_FLARE_easy_eta <- eta_sq(lmer_SHQ_FLARE_EASY_meantal_effort )

write.csv(SHQ_FLARE_easy_eta, 'C:\\Users\\adria\\Desktop\\SHQ_FLARE_easy_eta.csv')
...
lmer_SHQ_FLARE_HARD_mental_effort <- lmer(SHQ_Flare_hard_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                            protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

SHQ_FLARE_hard <- anova (lmer_SHQ_FLARE_HARD_mental_effort )

write.csv(SHQ_FLARE_hard, 'C:\\Users\\adria\\Desktop\\SHQ_FLARE_hard.csv')

SHQ_FLARE_hard_eta <- eta_sq(lmer_SHQ_FLARE_HARD_mental_effort )

write.csv(SHQ_FLARE_easy_eta, 'C:\\Users\\adria\\Desktop\\SHQ_FLARE_hard_eta.csv')
...
lmer_SHQ_MAP_EASY_mental_effort <- lmer(SHQ_Map_easy_normalzied ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                          protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

SHQ_MAP_easy <- anova (lmer_SHQ_MAP_EASY_mental_effort )

write.csv(SHQ_MAP_easy, 'C:\\Users\\adria\\Desktop\\SHQ_MAP_easy.csv')

SHQ_MAP_easy_eta <- eta_sq(lmer_SHQ_MAP_EASY_mental_effort )

write.csv(SHQ_MAP_easy_eta, 'C:\\Users\\adria\\Desktop\\SHQ_MAP_easy_eta.csv')
...
lmer_SHQ_MAP_HARD_mental_effort <- lmer(SHQ_Map_hard_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                          protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

SHQ_MAP_hard <- anova (lmer_SHQ_MAP_HARD_mental_effort )

write.csv(SHQ_MAP_hard, 'C:\\Users\\adria\\Desktop\\SHQ_MAP_hard.csv')

SHQ_MAP_hard_eta <- eta_sq(lmer_SHQ_MAP_HARD_mental_effort )

write.csv(SHQ_MAP_hard_eta, 'C:\\Users\\adria\\Desktop\\SHQ_MAP_hard_eta.csv')
...
lmer_Episodic_memory_ENCODING <- lmer(EM_encoding_normalzied ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                        protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)
...
lmer_Episodic_memory_RECALL <- lmer(EM_recall_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                      protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)
...
lmer_How_cognitively_demanding_was_all_the_session <- lmer(overall_normalized ~ as.factor(session_number) + age + sex + genotype + protocol + years_of_education + hours_of_sleep_baseline +
                                                             protocol*session_number + protocol*genotype + session_number*genotype + session_number*protocol*genotype + (1|id), data = mental_effort_1, na.action = na.exclude)

cog_demand <- anova (lmer_How_cognitively_demanding_was_all_the_session )

write.csv(cog_demand,'C:\\Users\\adria\\Desktop\\cog_demand.csv')

cog_demand_eta <- eta_sq(lmer_How_cognitively_demanding_was_all_the_session )

write.csv(cog_demand_eta,'C:\\Users\\adria\\Desktop\\cog_demand_eta.csv')
