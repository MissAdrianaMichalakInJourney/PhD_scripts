...
# n-back - mixed models - FINAL - AM - 12.01.2022
...
n_back <- data.frame ('id'= data$participant_ID,'age'= data$age,'sex'=data$Sex_M_1_F_2,'years_of_education'=data$years_spent_in_education,'session_number'=data$session_number,'protocol'=data$protocol_1_SD_2_MN, 'date' = data$date, 'time' = data$time,
...
lmer_RT_ONE_back <- lmer(normalized_RT_one_back ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                           protocol*session_number + (1|id), data=n_back_1_,  na.action = na.exclude)
...
lms_RT_ONE_back <- lsmeans(lmer_RT_ONE_back, ~ session_number*protocol) # plot main effect of: genotype, protocol
lms_RT_ONE_back
...
lmer_RT_TWO_back <- lmer(normalized_RT_two_back  ~ as.factor(session_number) + age + sex  + protocol + years_of_education + hours_of_sleep_baseline +
                           protocol*session_number  +(1|id), data=n_back_1_,  na.action = na.exclude)
...
lms_RT_TWO_back <- lsmeans(lmer_RT_TWO_back, ~ session_number*protocol) # plot main effect of: genotype, protocol
lms_RT_TWO_back
...
lmer_ACC_ONE_back <- lmer(normalized_accuracy_one_back^10 ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                            protocol*session_number +(1|id), data=n_back_1_,  na.action = na.exclude)
...
lms_ACC_ONE_back <- lsmeans(lmer_ACC_ONE_back, ~ session_number*protocol) # plot main effect of: genotype, protocol
lms_ACC_ONE_back
...
lmer_ACC_TWO_back <- lmer(normalized_accuracy_TWO_back^5 ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                            protocol*session_number +(1|id), data=n_back_1_,  na.action = na.exclude)
...
lms_ACC_TWO_back <- lsmeans(lmer_ACC_TWO_back, ~ session_number*protocol) # plot main effect of: genotype, protocol
lms_ACC_TWO_back
...
lmer_RT_ONE_back <- lmer(RT_one_back ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                           protocol*session_number +(1|id), data=n_back_1,  na.action = na.exclude)
...
lmer_RT_TWO_back <- lmer(RT_two_back  ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                           protocol*session_number + (1|id), data=n_back_1,  na.action = na.exclude)
...
lmer_ACC_ONE_back <- lmer(accuracy_one_back ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                            protocol*session_number +(1|id), data=n_back_1,  na.action = na.exclude)
...
lmer_ACC_TWO_back <- lmer(accuracy_two_back ~ as.factor(session_number) + age + sex + protocol + years_of_education + hours_of_sleep_baseline +
                            protocol*session_number +(1|id), data=n_back_1,  na.action = na.exclude)
