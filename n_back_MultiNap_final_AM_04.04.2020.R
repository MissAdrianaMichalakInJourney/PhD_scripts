...
# n-back - MultiNap - Adriana Michalak - 04.04.2020
...
setwd("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\n_back\\Data\\MultiNap") #set directory

getwd()

files <-dir(path = "C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\n_back\\Data\\MultiNap", recursive = TRUE,include.dirs = TRUE,pattern = "^APO(.*)csv$")
print (files)
...
{ 
  ...
  variables1 <- data.frame('participant_ID'= form[k],'session_number'=form1[k],'protocol_1_SD_2_MN'=2,'date' = my.data$SessionDate, 'time' = my.data$SessionTime, 'RT_ONE_back'=mean_one_back_RT, 'RT_TWO_back'=mean_two_back_RT, 'accuracy_ONE_back'=mean_one_back_ACC, 'accuracy_TWO_back'=mean_two_back_ACC)
  print(variables1)
...
outcomes_n_back_MultiNap <- do.call (rbind.data.frame, daisy)

write.csv (outcomes_n_back_MultiNap,"C:\\Users\\adria\\Desktop\\PhD\\Rrr\\COGT\\n_back\\Outcomes\\n_back_MultiNap_Final_16.12.2020.csv",row.names=F)
