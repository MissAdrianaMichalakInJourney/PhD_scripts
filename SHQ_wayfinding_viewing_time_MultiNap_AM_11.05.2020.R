...
# Extracting wayfinding duration + map viewing time from .json - SHQ - MultiNap - Adriana Michalak - 15.05.2020
...
for (k in 1:length(files)) {
  ...
  if (check_if_wayfinding[k]==TRUE) {
    ...
    pathOut= ("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\SHQ\\Outcomes\\SHQ_MultiNap\\Outcomes_wayfinding\\")
...
setwd("C:\\Users\\adria\\Desktop\\PhD\\Rrr\\SHQ\\Outcomes\\SHQ_MultiNap\\Outcomes_wayfinding\\") # set new directory

# select file names to be marged, i.e., outcomes from the for loop (look up)

select_files <- list.files (path="C:\\Users\\adria\\Desktop\\PhD\\Rrr\\SHQ\\Outcomes\\SHQ_MultiNap\\Outcomes_wayfinding\\", pattern = "outcomes") # search for the files with "outcome" in the name in the given directory
...
write.csv(outcomes.all.ppt,"C:\\Users\\adria\\Desktop\\PhD\\Rrr\\SHQ\\Outcomes\\SHQ_outcomes_wayfinding_viewing_duration_MultiNap_AM_15.12.2020.csv",row.names=F) # it will generate the .csv with the outcomes of interest for each participants, we will marge them below
